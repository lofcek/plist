...
func TestUnmarshalPlist(t *testing.T) {
	...
	test_cases := [...]TestUnmarshal{
		...
		{"unmarshalOverflow", `<integer>256</integer>`, &i8, UnmarshalExpectsError{&strconv.NumError{}}},
		{"wrong type", `<integer>256</integer>`, &s, UnmarshalExpectsError{&UnexpectedTokenError{}}},
		...
		{"unmarshalToChan", `<integer>10</integer>`, new(chan int), UnmarshalExpectsError{&CannotParseTypeError{}}},
		...
		{"not empty space", `<true/>  aa`, &b, UnmarshalExpectsError{&UnexpectedTokenError{}}},
		...
		{"wrong xml", `<array></integer>`, &ai, UnmarshalExpectsError{&xml.SyntaxError{}}},
		...
		{"wrong tag", `<not-dict></not-dict>`, &s1, UnmarshalExpectsError{&UnexpectedTokenError{}}},
